...
export const AdminDashboard = () => {
  ...
  const [loyaltyConfig, setLoyaltyConfig] = useState({
    ...
    tiers: [
      { tierId: 1, tierName: 'Standard', minRankingBalance: 0, pointMultiplier: 1.0, discountPercent: 0, bookingWindowDays: 7 },
      { tierId: 2, tierName: 'Silver', minRankingBalance: 500, pointMultiplier: 1.1, discountPercent: 2, bookingWindowDays: 10 },
      { tierId: 3, tierName: 'Gold', minRankingBalance: 2000, pointMultiplier: 1.2, discountPercent: 5, bookingWindowDays: 12 },
      { tierId: 4, tierName: 'Platinum', minRankingBalance: 5000, pointMultiplier: 1.5, discountPercent: 10, bookingWindowDays: 14 }
    ]
  });
        ...
        <>
          ...
          <div className="row g-3 mb-4">
            <div className="col-lg-3 col-sm-6">
              <div className="app-card border-0 p-3.5 bg-white rounded-4 h-100">
                <small className="text-muted d-block fw-bold" style={{ fontSize: '0.62rem', letterSpacing: '0.5px' }}>DOANH THU HÔM NAY</small>
                <h4 className="fw-bold text-cyan mt-1 mb-1">{realtimeCounters.todayRevenue.toLocaleString()}đ</h4>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="app-card border-0 p-3.5 bg-white rounded-4 h-100">
                <small className="text-muted d-block fw-bold" style={{ fontSize: '0.62rem', letterSpacing: '0.5px' }}>LỊCH ĐẶT HÔM NAY</small>
                <h4 className="fw-bold text-dark mt-1 mb-1">{realtimeCounters.todayBookingsCount} lượt</h4>
                <small className="text-secondary" style={{ fontSize: '0.68rem' }}>Đặt hẹn từ app khách hàng</small>
              </div>
            </div>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="app-card border-0 p-3.5 bg-white rounded-4 h-100">
                <small className="text-muted d-block fw-bold" style={{ fontSize: '0.62rem', letterSpacing: '0.5px' }}>XE ĐANG RỬA & SẤY</small>
                <h4 className="fw-bold text-primary mt-1 mb-1">{realtimeCounters.washingCount} xe</h4>
                <small className="text-cyan fw-bold" style={{ fontSize: '0.68rem' }}>Đang thực hiện công việc</small>
              </div>
            </div>

            <div className="col-lg-3 col-sm-6">
              <div className="app-card border-0 p-3.5 bg-white rounded-4 h-100">
                <small className="text-muted d-block fw-bold" style={{ fontSize: '0.62rem', letterSpacing: '0.5px' }}>HOÀN THÀNH HÔM NAY</small>
                <h4 className="fw-bold text-success mt-1 mb-1">{realtimeCounters.completedCount} xe</h4>
                <small className="text-secondary" style={{ fontSize: '0.68rem' }}>Đã qua quy trình rửa</small>
              </div>
            </div>

            <div className="col-lg-3 col-sm-6">
              <div className="app-card border-0 p-3.5 bg-white rounded-4 h-100">
                <small className="text-muted d-block fw-bold" style={{ fontSize: '0.62rem', letterSpacing: '0.5px' }}>VOUCHER ĐÃ DÙNG</small>
                <h4 className="fw-bold text-danger mt-1 mb-1">{realtimeCounters.voucherUsedCount} voucher</h4>
                <small className="text-secondary" style={{ fontSize: '0.68rem' }}>Áp dụng ưu đãi giảm giá</small>
              </div>
            </div>

            <div className="col-lg-3 col-sm-6">
              <div className="app-card border-0 p-3.5 bg-white rounded-4 h-100">
                <small className="text-muted d-block fw-bold" style={{ fontSize: '0.62rem', letterSpacing: '0.5px' }}>LOYALTY POINTS ĐÃ CỘNG</small>
                <h4 className="fw-bold text-warning mt-1 mb-1">+{realtimeCounters.loyaltyPointsGrantedToday} PTS</h4>
                <small className="text-secondary" style={{ fontSize: '0.68rem' }}>Tích điểm cho khách hàng</small>
              </div>
            </div>

            <div className="col-lg-3 col-sm-6">
              <div className="app-card border-0 p-3.5 bg-white rounded-4 h-100">
                <small className="text-muted d-block fw-bold" style={{ fontSize: '0.62rem', letterSpacing: '0.5px' }}>ĐÁNH GIÁ TRUNG BÌNH</small>
                <h4 className="fw-bold text-warning mt-1 mb-1">{stats.avgStars} <i className="fas fa-star" style={{ color: '#ffcf33', fontSize: '1.1rem' }}></i></h4>
                <small className="text-secondary" style={{ fontSize: '0.68rem' }}>Lượt phản hồi từ khách hàng</small>
              </div>
            </div>
          </div>
          ...
          <div className="row g-4">
            ...
            <div className="col-lg-8">
              <div className="app-card border-0 shadow-sm p-4 bg-white rounded-4" style={{ minHeight: '380px' }}>
                <h5 className="fw-bold mb-4" style={{ color: 'var(--navy-dark)', fontSize: '0.95rem' }}>
                  <i className="fas fa-chart-bar text-cyan me-2"></i>BIỂU ĐỒ DOANH THU CHI TIẾT 7 NGÀY GẦN NHẤT
                </h5>
            ...
            <div className="col-lg-4">
              <div className="app-card border-0 shadow-sm p-4 bg-white rounded-4" style={{ minHeight: '380px' }}>
                <h5 className="fw-bold mb-4" style={{ color: 'var(--navy-dark)', fontSize: '0.95rem' }}>
                  <i className="fas fa-chart-pie text-cyan me-2"></i>PHÂN BỐ THÀNH VIÊN LOYALTY
                </h5>
                    ...
                    return (
                      <div key={tier} className="text-start">
                        <div className="d-flex justify-content-between align-items-center mb-1">
                          <span className="fw-bold small text-dark">{tier} Loyalty</span>
                          <span className="text-muted small fw-bold">{count} thành viên ({pct}%)</span>
                        </div>
      ...
      {activeTab === 'loyalty' && (
        <div className="app-card border-0 shadow-sm p-4 bg-white rounded-4">
          <h5 className="fw-bold mb-4 border-bottom pb-2.5" style={{ color: 'var(--navy-dark)' }}>
            <i className="fas fa-cogs text-cyan me-2"></i>CẤU HÌNH QUY CHẾ ĐẶC QUYỀN AUTOWASH LOYALTY
          </h5>
          <form onSubmit={handleSaveLoyaltyConfig}>
            <div className="row g-3 mb-4">
              <div className="col-md-3">
                <label className="form-label small fw-bold text-muted">SỐ ĐIỂM TÍCH LŨY / 1.000đ CHI TIÊU</label>
                <input
                  type="number"
              ...
              <div className="col-md-3">
                <label className="form-label small fw-bold text-muted">HẠN DÙNG ĐIỂM LOYALTY (THÁNG)</label>
                <input
                  type="number"
                  className="form-control bg-light border-0 py-2.5 rounded-3 text-dark fw-bold"
              ...
              <div className="col-md-3">
                <label className="form-label small fw-bold text-muted">VÒNG REVIEW (NĂM)</label>
                <input
                  type="number"
                  className="form-control bg-light border-0 py-2.5 rounded-3 text-dark fw-bold"
            ...
            <h6 className="fw-bold mb-3 mt-4" style={{ color: 'var(--navy-dark)' }}>ĐẶC QUYỀN VIP CHO TỪNG PHÂN HẠNG LOYALTY</h6>
              ...
              {loyaltyConfig.tiers.map((t, i) => {
                ...
                return (
                  <div key={t.tierId} className="col-md-3">
                    <div className="p-3 rounded-4 border text-white shadow-sm h-100 d-flex flex-column justify-content-between" style={{ background: colors[t.tierName] || '#0f172a' }}>
                      <div>
                        <div className="fw-bold text-uppercase" style={{ fontSize: '0.9rem', letterSpacing: '0.5px' }}>{t.tierName} Loyalty</div>
                        <small className="opacity-75 d-block mt-1">Ngưỡng điểm tối thiểu: <strong>{t.minRankingBalance.toLocaleString()} PTS</strong></small>
                      </div>
                      
                      <div className="mt-3 d-flex flex-column gap-2 bg-white bg-opacity-10 p-2.5 rounded-3 text-start" style={{ fontSize: '0.72rem' }}>
                        <div>
                        ...
                        <div>
                          <label className="opacity-75 d-block">CHIẾT KHẤU (%)</label>
                          <input
                            type="number"
                            className="form-control form-control-sm bg-transparent border-0 text-white fw-bold p-0"
                        ...
                        <div>
                          <label className="opacity-75 d-block">ĐẶT LỊCH TRƯỚC (NGÀY)</label>
                          <input
                            type="number"
                            className="form-control form-control-sm bg-transparent border-0 text-white fw-bold p-0"
            ...
            <button type="submit" className="app-btn-primary py-2.5 px-5 mt-4 text-dark fw-bold border-0" style={{ borderRadius: '12px', background: 'var(--cyan-electric)' }}>
      ...
      {activeTab === 'tierReview' && (
        <div className="app-card border-0 shadow-sm p-4 bg-white rounded-4">
          <div className="d-flex justify-content-between align-items-center flex-wrap mb-4 border-bottom pb-2.5">
            ...
            <button className="app-btn-primary py-2 px-4 shadow-none border-0 text-dark fw-bold" style={{ borderRadius: '10px', background: 'var(--cyan-electric)' }} onClick={handleRunTierReview}>
                  ...
                  reviewList.map((item, idx) => {
                    ...
                    return (
                      <tr key={idx} style={{ borderBottom: '1px solid #f1f5f9' }}>
                        ...
                        <td>
                          <span className={`${dirClass} px-3 py-1.5 rounded-pill fw-bold`} style={{ fontSize: '0.62rem' }}>{dirLabel}</span>
                        </td>
